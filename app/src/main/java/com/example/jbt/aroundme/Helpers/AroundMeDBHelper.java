...
public class AroundMeDBHelper extends SQLiteOpenHelper {
    ...
    private static final String SEARCH_COL_PHOTO_REF = "photo";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createSearchTable = String.format( // holds all user created movies
                ...
                SEARCH_COL_LOC_LAT, SEARCH_COL_LOC_LNG, SEARCH_COL_ICON, SEARCH_COL_PHOTO_REF,
                SEARCH_COL_PLACE_ID, SEARCH_COL_RATING, SEARCH_COL_REFERENCE, SEARCH_COL_SCOPE,
                SEARCH_COL_TYPES, SEARCH_COL_VICINITY );
    ...
    public void bulkInsertSearchResults(ArrayList<Place> places) {
        ...
        try
        {
            for (int i=0; i< places.size(); i++)
            {
                ...
                values[i].put(SEARCH_COL_PHOTO_REF, places.get(i).getFirstPhotoRef());
